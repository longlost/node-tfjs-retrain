...
const loadDecapitatedMobilenet = async () => {
  ...
  // inop as of 7/15/2019 v2 models: https://github.com/tensorflow/models/blob/master/research/slim/nets/mobilenet/README.md
...
class Model {
  ...
  async saveModel(dirPath) {
    ...
    //     dataset.shape[0] * trainingParams.batchSizeFraction
    //   );
